...
export class FeedbackCreateRequestModel extends Serializable{

    @SerializeProperty({ map: 'feedback_primary', type: FeedbackPrimaryModel})
	private _feedback_primary: FeedbackPrimaryModel = new FeedbackPrimaryModel();

    @SerializeProperty({ map: 'feedback_additional', type: FeedbackAdditionalModel})
	private _feedback_additional: FeedbackAdditionalModel = new FeedbackAdditionalModel();
